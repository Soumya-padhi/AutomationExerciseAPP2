...
public class VerifyProducts extends AbstractMethods1{
	...
	public void addreview() throws IOException {
		...
		try {
			...
			String name1 = prop.getProperty("name");name.sendKeys(name1);
			String emailid1 = prop.getProperty("emailid");emailid.sendKeys(emailid1);
			String review1 = prop.getProperty("review");review.sendKeys(review1);
