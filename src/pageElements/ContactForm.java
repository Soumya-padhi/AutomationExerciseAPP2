...
public class ContactForm extends AbstractMethods1{
	...
	public void contactform() {
		...
		try {
			...
			ReusableMethods1 cf = new ReusableMethods1(driver);
			cf.contactform();

			uploadfile.sendKeys(System.getProperty("user.dir") + ("\\src\\testData\\Data.xlsx"));
